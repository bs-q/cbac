...
public class RevenueItem extends AbstractFlexibleItem<RevenueItem.TestItemViewHolder>
        implements ISectionable<RevenueItem.TestItemViewHolder, HeaderItem>, Serializable {
    ...
    public void bindViewHolder(FlexibleAdapter<IFlexible> adapter, TestItemViewHolder holder, int position, List<Object> payloads) {
        ...
        holder.itemView.setOnClickListener(s->listener.itemClick(id));
    }
    ...
    private RevenueItem(Integer id){
        super();
        this.id = id;

    }

    public RevenueItem(Integer id, HeaderItem headerItem,Integer name,RevenueItemClick listener){
        this(id);
